...
# Parsing + Configuration Script – UC300 - Rev. A

This **Parsing + Configuration** script is designed for the **UC300** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – UC300 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **UC300** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
